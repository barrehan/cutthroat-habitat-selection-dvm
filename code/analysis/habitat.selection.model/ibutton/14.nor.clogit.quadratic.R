...
pred.vals.noon.avgDO <- data.frame(standardized.do = -0.3603449,
...
pred.vals.night.lowDO <- data.frame(standardized.do = -0.3603449,
...
# AIC of model options ----------------------------------------------------

high.clogit.temp.quad<-clogit(formula = case ~
                                standardized.temp+
                                standardized.do+
...
high.clogit.temp.quad.interaction <-clogit(formula = case ~
                                             standardized.temp+
                                             standardized.do+
                                             standardized.temp:standardized.do+
                                             I(standardized.temp^2)+ 
