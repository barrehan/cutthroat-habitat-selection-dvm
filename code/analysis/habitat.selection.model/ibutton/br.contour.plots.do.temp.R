...
for(i in 1:length(q1.do)){
  for(j in 1:length(q1.temp)){
    q1[i,j]<-(-2.85342*q1.do[i] + 0.57525*q1.temp[j]+0.29928*(q1.do[i]*q1.temp[j]))
  }
}
...
for(i in 1:length(q2.do)){
  for(j in 1:length(q2.temp)){
    q2[i,j]<-(0.47140*q2.do[i] -1.18046*q2.temp[j]-0.57055*(q2.do[i]*q2.temp[j]))
  }
}
...
for(i in 1:length(q3.do)){
  for(j in 1:length(q3.temp)){
    q3[i,j]<-(2.32899*q3.do[i]-1.73230*q3.temp[j]-0.84884*(q3.do[i]*q3.temp[j]))
  }
}
...
for(i in 1:length(q4.do)){
  for(j in 1:length(q4.temp)){
    q4[i,j]<-(0.36463 *q4.do[i]-0.95403*q4.temp[j]-0.95250 *(q4.do[i]*q4.temp[j]))
  }
}
