...
##DO 8mg/L, time 18:00 & 19:00

pred.vals.noon.highDO <- data.frame(standardized.do = 1.336164,
...
pred.vals.noon.midDO <- data.frame(standardized.do = 0.06378223,
                                   standardized.temp = seq(min(high.int$standardized.temp, na.rm = T),
                                                           max(high.int$standardized.temp, na.rm = T), 
                                                           0.1),
                                   stratID = 91)
...
pred.vals.noon.lowDO <- data.frame(standardized.do = -1.208599,
                                   standardized.temp = seq(min(high.int$standardized.temp, na.rm = T),
                                                           max(high.int$standardized.temp, na.rm = T), 
                                                           0.1),
                                   stratID = 91)
...
pred.vals.night.highDO <- data.frame(standardized.do = 1.336164,
...
pred.vals.night.midDO <- data.frame(standardized.do = 0.06378223,
                                    standardized.temp = seq(min(low.int$standardized.temp, na.rm = T),
                                                            max(low.int$standardized.temp, na.rm = T), 
                                                            0.1),
                                    stratID = 31)
...
pred.vals.night.lowDO <- data.frame(standardized.do = -1.208599,
                                    standardized.temp = seq(min(low.int$standardized.temp, na.rm = T),
                                                            max(low.int$standardized.temp, na.rm = T), 
                                                            0.1),
                                    stratID = 31)
