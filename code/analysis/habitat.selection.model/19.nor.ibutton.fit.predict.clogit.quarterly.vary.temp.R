...
pred.vals.quart1.vary.do <- data.frame(standardized.temp = 0.5538693, 
...
pred.vals.quart2.vary.do <- data.frame(standardized.temp = 0.5538693,
...
pred.vals.quart3.vary.do <- data.frame(standardized.temp = 0.5538693,
...
pred.vals.quart4.vary.do <- data.frame(standardized.temp = 0.5538693,
...
plot.do <- ggplot(preds.do, aes(x=standardized.do, y=fit, color=time, fill=time, group=time)) +
  ...
  theme_classic()+
  labs(title = "Norwood fish dissolved oxygen selection",
       subtitle = "Temperature held at 15°C")+
  xlab("Standardized dissolved oxygen (mg/L)") + ylab("Relative Probability of Selection")+
  theme(legend.title = element_blank()) 

ggsave(plot.do, filename = paste("results/figures/hab.select.mod.figures/norwood.quarterly.do.selection.temp.15C.png"), width = 16, height = 8, units = "cm")
...
pred.vals.quart1.vary.do <- data.frame(standardized.temp = -0.7879769, 
                                       standardized.do = seq(min(quart1$standardized.do, na.rm = T),
                                                             max(quart1$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 1)
...
pred.vals.quart2.vary.do <- data.frame(standardized.temp = -0.7879769,
                                       standardized.do = seq(min(quart2$standardized.do, na.rm = T),
                                                             max(quart2$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 31)
...
pred.vals.quart3.vary.do <- data.frame(standardized.temp = -0.7879769,
                                       standardized.do = seq(min(quart3$standardized.do, na.rm = T),
                                                             max(quart3$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 61)
...
pred.vals.quart4.vary.do <- data.frame(standardized.temp = -0.7879769,
                                       standardized.do = seq(min(quart4$standardized.do, na.rm = T),
                                                             max(quart4$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 91)
...
ggsave(plot.do, filename = paste("results/figures/hab.select.mod.figures/norwood.quarterly.do.selection.temp.13C.png"), width = 16, height = 8, units = "cm")
...
pred.vals.quart1.vary.do <- data.frame(standardized.temp = 1.895715, 
                                       standardized.do = seq(min(quart1$standardized.do, na.rm = T),
                                                             max(quart1$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 1)
...
pred.vals.quart2.vary.do <- data.frame(standardized.temp = 1.895715,
                                       standardized.do = seq(min(quart2$standardized.do, na.rm = T),
                                                             max(quart2$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 31)
...
pred.vals.quart3.vary.do <- data.frame(standardized.temp = 1.895715,
                                       standardized.do = seq(min(quart3$standardized.do, na.rm = T),
                                                             max(quart3$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 61)
...
pred.vals.quart4.vary.do <- data.frame(standardized.temp = 1.895715,
                                       standardized.do = seq(min(quart4$standardized.do, na.rm = T),
                                                             max(quart4$standardized.do, na.rm = T), 
                                                             0.1),
                                       stratID = 91)
...
ggsave(plot.do, filename = paste("results/figures/hab.select.mod.figures/norwood.quarterly.do.selection.temp.17C.png"), width = 16, height = 8, units = "cm")
