#'12/21/2022
#'here I am combining the randomly generated do/temp data with the radio tag 
#'data for blue ruin into one data frame
...
write.csv(final, "data/modif.data/hab.select.mod/br.radio.tag.data/br.rt.with.interpolated.do.temp.csv", row.names = F)
